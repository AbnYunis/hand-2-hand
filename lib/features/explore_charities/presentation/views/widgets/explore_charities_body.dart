                ...
                children: [
                  Container(
                    ...
                    child: TextField(
                      ...
                      onChanged: (value) {
                        BlocProvider.of<GetCharitiesCubit>(context)
                  ...
                  if (controller.text.isEmpty &&
                      state is GetCharitiesSuccess) ...[
                    ExploreCharitiesGridView(
                      charities: state.charities,
                    )
                  ],
                  if (state is GetCharitiesLoading ||
                      state is GetSearchCharitiesLoading) ...[
                    const Center(
                      child: CircularProgressIndicator(),
                    )
                  ],
                  if (state is GetCharitiesFailure ||
                      state is GetSearchCharitiesFailure) ...[
                    const Center(
